    ...
    editor.insertPortableTextData = data => {
      ...
      if (pText) {
        ...
        if (Array.isArray(parsed) && parsed.length > 0) {
          var slateValue = regenerateKeys(editor, (0, _values.toSlateValue)(parsed, blockTypeName), keyGenerator, spanTypeName); // Validate the result
    ...
    editor.insertTextOrHTMLData = data => {
      ...
      if (html || text) {
        ...
        if (html) {
          ...
          fragment = (0, _values.toSlateValue)(portableText, blockTypeName);
          insertedType = 'HTML';
        } else {
          // plain text
          ...
          fragment = (0, _values.toSlateValue)(portableText, blockTypeName).map(block => (0, _blockTools.normalizeBlock)(block, {
            blockTypeName
          }));
          insertedType = 'text';
        } // Validate the result
    ...
    if (editor.isTextBlock(newNode)) {
      newNode.markDefs = newNode.markDefs.map(def => {
        ...
        if (Array.isArray(newNode.children)) {
          newNode.children = newNode.children.map(child => child._type === spanTypeName ? _objectSpread(_objectSpread({}, child), {}, {
