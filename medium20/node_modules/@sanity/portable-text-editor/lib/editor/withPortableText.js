...
var withPortableText = (editor, options) => {
  ...
  var withPortableTextMarkModel = (0, _plugins.createWithPortableTextMarkModel)(portableTextFeatures, change$);
  ...
  return withPortableTextSelections(withPatches(withUndoRedo(withMaxBlocks(withUtils(withPortableTextLists(withPortableTextBlockStyle(withPortableTextMarkModel(withObjectKeys(withSchemaTypes(e))))))))));
};
